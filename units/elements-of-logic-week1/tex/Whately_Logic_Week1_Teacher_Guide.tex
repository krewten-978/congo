...
\item \textit{Macbeth Lit-Anchor: Prophecy Is Not Proof} — Shakespeare anchor passage for applying Whately's four questions to Macbeth's movement from prophecy to inference, ambition, and moral responsibility.
...
\begin{itemize}[leftmargin=*]
\item Read the guided Act 1, Scene 3 excerpt from the lit-anchor: the witches' greeting, Ross's confirmation of Cawdor, Banquo's warning, and Macbeth's first aside.
...
\item Have students read the Act 1, Scene 7 independent passage and begin the \textit{Macbeth Argument Skeleton} portfolio artifact.
\end{itemize}

\subsection*{Day 5: Repair, Portfolio, and Exit Claim}
\begin{itemize}[leftmargin=*]
\item Students finish either the repaired argument/original test-case work from the lab or the \textit{Macbeth Argument Skeleton} from the lit-anchor.
...
\item Collect the student reading, argument lab, lit-anchor portfolio artifact, and logic test as the week's work product.
\end{itemize}
...
\item \textbf{Independent passage:} Act 1, Scene 7, Macbeth's soliloquy before Duncan's murder.
\item \textbf{Central logical pressure:} prediction is not permission; possibility is not command; desire is not proof.
\item \textbf{Portfolio artifact:} Macbeth argument skeleton: claim/conclusion, stated reason, hidden assumption, and test.
\end{itemize}
