...
\begin{itemize}[leftmargin=*]
\item \textbf{Fair Judge:} The two-faced word is \textit{fair}. First it means just or impartial; then it means pleasant, clear, or not rainy. This is equivocation because the argument moves from one meaning to another. Rainy weather does not prove an unjust trial.
